...
function login_or_register_user($phone, $name = null, $remember_me = true) {
    ...
    unset($_SESSION['vendor_id'], $_SESSION['vendor_name'], $_SESSION['vendor_login_time']);
...
function login_admin($phone, $password) {
    ...
    // ضمان عدم تداخل الجلسات بين الأدوار
    unset($_SESSION['user_id'], $_SESSION['session_token'], $_SESSION['user_phone'], $_SESSION['user_name'], $_SESSION['login_time']);
    unset($_SESSION['vendor_id'], $_SESSION['vendor_name'], $_SESSION['vendor_login_time']);
    unset($_SESSION['driver_id'], $_SESSION['driver_name'], $_SESSION['driver_login_time']);
